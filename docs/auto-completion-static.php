...
class Cart
{
     ...
     * @see Cart::create
     */
    public static function create($data = [], array $attributes = []): \Wei\Ret
    {
    }
     ...
     * @see Cart::update
     */
    public static function update($data): \Wei\Ret
    {
    }
     ...
     * @param array|Req $data
     * @return Ret|array{data:CartModel}
     * @see Cart::createOrUpdate
     */
    public static function createOrUpdate($data): \Wei\Ret
    {
    }
}
...
class CartConfigModel
{
    /**
     * Query: Filter by current user id
     *
     * @return $this
     * @see CartConfigModel::mine
     */
     ...
     *
     * @return $this
     * @see CartConfigModel::findOrInitMine
     */
     ...
     *
     * @return self
     * @see CartConfigModel::findOrInitMineCached
     */
     ...
     * @return $this
     * @see CartConfigModel::saveAttributes
     */
     ...
     * @see CartConfigModel::destroyOrFail
     */
     ...
     * @return $this
     * @throws \Exception
     * @see CartConfigModel::findOrFail
     */
     ...
     * @return $this
     * @see CartConfigModel::findOrInit
     */
     ...
     * @return $this
     * @see CartConfigModel::findOrCreate
     */
     ...
     * @return $this
     * @see CartConfigModel::findByOrCreate
     */
     ...
     * @param array|object $data
     * @return $this
     * @see CartConfigModel::findOrInitBy
     */
     ...
     * @return $this
     * @throws \Exception
     * @see CartConfigModel::findByOrFail
     */
     ...
     * @return $this
     * @throws \Exception
     * @see CartConfigModel::findFromReq
     */
     ...
     * @return $this
     * @see CartConfigModel::setCacheTime
     */
     ...
     *
     * @return array
     * @see CartConfigModel::getColumns
     */
     ...
     * @return $this
     * @see CartConfigModel::selectDistinct
     */
     ...
     * @param array|string $columns
     * @return $this
     * @see CartConfigModel::selectExcept
     */
     ...
     * @param string $column
     * @return $this
     * @see CartConfigModel::selectMain
     */
     ...
     * @param array $params
     * @return $this
     * @see CartConfigModel::whereBetween
     */
     ...
     * @param array $params
     * @return $this
     * @see CartConfigModel::whereNotBetween
     */
     ...
     * @param array $params
     * @return $this
     * @see CartConfigModel::whereNotIn
     */
     ...
     * @param string $column
     * @return $this
     * @see CartConfigModel::whereNotNull
     */
     ...
     * @param mixed|null $value
     * @return $this
     * @see CartConfigModel::whereMonth
     */
     ...
     * @return $this
     * @see CartConfigModel::whereColumn
     */
     ...
     * @return $this
     * @see CartConfigModel::whereContains
     */
     ...
     * @param string $condition
     * @return $this
     * @see CartConfigModel::whereNotContains
     */
     ...
     * @param string $column
     * @return $this
     * @see CartConfigModel::whereNotHas
     */
     ...
     * @return $this
     * @see CartConfigModel::setDbKeyConverter
     */
     ...
     * @param callable|null $converter
     * @return $this
     * @see CartConfigModel::setPhpKeyConverter
     */
     ...
     * @param string $type
     * @return $this
     * @see CartConfigModel::joinRelation
     */
     ...
     * @param string|array $name
     * @return $this
     * @see CartConfigModel::innerJoinRelation
     */
     ...
     * @param string|array $name
     * @return $this
     * @see CartConfigModel::leftJoinRelation
     */
     ...
     * @param string|array $name
     * @return $this
     * @see CartConfigModel::rightJoinRelation
     */
     ...
     * @param string $method
     * @return bool
     * @see CartConfigModel::isRelation
     */
...
class CartModel
{
     ...
     * @see CartModel::init
     */
    public static function init($data = []): \Wei\Ret
    {
    }
     ...
     *
     * @return self
     * @see CartModel::findOrInitMineCached
     */
    public static function findOrInitMineCached(): self
    {
    }
     ...
     * @param string $condition
     * @return $this
     * @see CartModel::whereNotContains
     */
    public static function whereNotContains(string $column, $value, string $condition = 'OR'): self
    {
    }
     ...
     * @param callable|null $converter
     * @return $this
     * @see CartModel::setDbKeyConverter
     */
    public static function setDbKeyConverter(callable $converter = null): self
    {
    }
     ...
     * @param callable|null $converter
     * @return $this
     * @see CartModel::setPhpKeyConverter
     */
    public static function setPhpKeyConverter(callable $converter = null): self
    {
    }
     ...
     * @param string|array $name
     * @return $this
     * @see CartModel::innerJoinRelation
     */
    public static function innerJoinRelation($name): self
    {
    }
     ...
     * @param string|array $name
     * @return $this
     * @see CartModel::leftJoinRelation
     */
    public static function leftJoinRelation($name): self
    {
    }
     ...
     * @param string|array $name
     * @return $this
     * @see CartModel::rightJoinRelation
     */
    public static function rightJoinRelation($name): self
    {
    }
...
if (0) {
    class Cart
    {
         ...
         * @see Cart::create
         */
        public function create($data = [], array $attributes = []): \Wei\Ret
        {
        }
         ...
         * @see Cart::update
         */
        public function update($data): \Wei\Ret
        {
        }
         ...
         * @see Cart::createOrUpdate
         */
        public function createOrUpdate($data): \Wei\Ret
        {
        }
    }
    ...
    class CartModel
    {
         ...
         * @see CartModel::init
         */
        public function init($data = []): \Wei\Ret
        {
        }
